...
> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/lambda/LambdaTest.java)
...
> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/lambda/FunctionInterfaceTest.java)

接口内只有一个抽象方法

java 在 `java.util.function` 包下提供部分函数式接口

| 函数式接口       | 称谓   | 参数类型 | 用途                                                                   |
| ---------------- | ------ | -------- | ---------------------------------------------------------------------- |
| `Consumer<T>`    | 消费型 | T        | 对 T 进行操作<br/>使用 `void accept(T t)` 方法                         |
| `Supplier<T>`    | 供给型 | 无       | 返回 T 对象<br/>使用 `T get()` 方法                                    |
| `Function<T, R>` | 函数型 | T        | 对 T 进行操作<br/>返回 R<br/>使用 `R apply(T t)` 方法                  |
| `Predicate<T>`   | 判断型 | T        | 对 T 进行判断<br/>返回 true 或 false<br/>使用 `boolean test(T t)` 方法 |
...
方法引用是基于 Lambda 表达式的，是对 Lambda 表达式的进一步简化

如果一个对象的方法或静态方法与某个函数式接口的抽象方法的参数和返回值相同，则可以使用 `对象::方法` 或 `类::静态方法` 替换

> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/reference/MethodRefTest.java)
...
> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/reference/ConstructorRefTest.java)
...
> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/stream/InitTest.java)
...
> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/stream/OperateTest.java)
...
> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/stream/TerminateTest.java)
...
> [详细代码](https://github.com/follow1123/java-language-examples/tree/main/version-features/java8/src/main/java/org/example/optional/OptionalTest.java)
...
> <InternalLink text="参考" href="java/language/commonly-apis/datetime" />

### 接口默认方法

> <InternalLink
>     text="参考"
>     href="java/language/object-oriented/interface/#接口新特性"
> />
