...
> [代码](https://github.com/follow1123/java-language-examples/tree/main/syntax/src/main/java/org/example/oop/encapsulation/A.java)

定义一个 `A` 类，定义 4 个属性，分别有 4 种不同的权限修饰符
...
在 `A` 类相同包下定义一个 `B` 类，使用 main 方法访问 `A` 类的所有属性
...
在 `A` 类的子包下定义一个 `packag2.D` 类，使用 main 方法访问 `A` 类的所有属性
...
Java 中声明的类，如果没有显式的声明其父类时，默认继承与 `java.lang.Object`

- 一个类可以 `同时拥有` 多个子类
- 一个类不可以 `同时继承` 多个父类（Java只支持单继承，不支持多继承）

> [代码](https://github.com/follow1123/java-language-examples/tree/main/syntax/src/main/java/org/example/oop/inheritance/InheritanceTest.java)
...
- 父类的返回值时 void，子类也必须是 void
- 返回值是基本数据类型，子类必须相同
- 返回值是引用数据类型，子类可以相同，或是其子类

异常

子类重写方法抛出的异常必须和父类方法抛出的异常相同或则是其子类

方法体没有要求
:::

> [代码](https://github.com/follow1123/java-language-examples/tree/main/syntax/src/main/java/org/example/oop/override/OverrideTest.java)
...
如果首行没有显示调用 this 或 super 构造器，则默认调用 `super()` 空参构造器
:::

> [代码](https://github.com/follow1123/java-language-examples/tree/main/syntax/src/main/java/org/example/oop/keywords/superkeyword/SuperTest.java)
...
> [代码](https://github.com/follow1123/java-language-examples/tree/main/syntax/src/main/java/org/example/oop/polymorphism/PolymorphismTest.java)
