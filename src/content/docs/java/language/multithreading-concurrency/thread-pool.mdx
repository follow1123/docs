...
> [代码](https://github.com/follow1123/java-language-examples/tree/main/standard-library/src/main/java/org/example/juc/pool/custom)

## `ThreadPoolExecutor`

> [代码](https://github.com/follow1123/java-language-examples/tree/main/standard-library/src/main/java/org/example/juc/pool/ThreadPoolExecutorTest.java)
