...
* **三种模式**
  ...
  * 根据实际业务：简单工厂模式
  ...
  ![methodFactory](./assets/methodFactory.png)
...
![abstructFactory](./assets/abstructFactory.png)
...
* 模式中的角色
  ...
  * 适配器（Adapter）：通过包装一个需要适配的对象，把原接口转换成目标接口
  ...
  ![适配器模式](./assets/适配器模式-1597033069207.png)
